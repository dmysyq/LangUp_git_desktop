...
public class GrammarResultsActivity extends AppCompatActivity {
    ...
    private class ResultsAdapter extends RecyclerView.Adapter<ResultsAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            holder.questionText.setText(String.valueOf(item.number));
            holder.userAnswerText.setText(formattedSentence);
            holder.correctAnswerText.setText(item.correctAnswer);
            holder.explanationText.setText(item.isCorrect ? 
                R.string.correct : R.string.incorrect);
            holder.explanationText.setTextColor(getColor(item.isCorrect ? 
