...
public class LevelSelectionActivity extends AppCompatActivity {
    ...
    private void initializeViews() {
        ...
        buildingButton.setOnClickListener(v -> startBuildingActivity());
    }
    ...
    private void startQuestionsActivity() {
        // Start Questions activity with the selected series
    ...
    private void startBuildingActivity() {
        // Start Building activity with the selected series
